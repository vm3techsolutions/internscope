...
var useEmailSubscriptionForm = function useEmailSubscriptionForm(_ref) {
  ...
  var emailInputProps = React.useMemo(function () {
    return _extends({
...
var useToggleState = function useToggleState(initialState) {
  ...
  var handleOn = React.useCallback(function () {
    setIsOn(true);
  }, []);
  var handleOff = React.useCallback(function () {
    setIsOn(false);
  }, []);
...
var InternalContextProvider = function InternalContextProvider(_ref) {
  ...
  var cartLocalStorage = React.useMemo(function () {
    return {
      set: function set(id) {
  ...
  var createCart = React.useCallback( /*#__PURE__*/function () {
  ...
  var getOrCreateCart = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
  ...
  var onAddLineItem = React.useCallback( /*#__PURE__*/function () {
  ...
  var onUpdateLineItem = React.useCallback( /*#__PURE__*/function () {
  ...
  var onRemoveLineItem = React.useCallback( /*#__PURE__*/function () {
  ...
  var cartItemsCount = React.useMemo(function () {
...
var useProductHelper = function useProductHelper(product) {
  ...
  var handleSelectOption = React.useCallback(function (name, value) {
  ...
  var optionsToSelect = React.useMemo(function () {
  ...
  var handleAddToCart = React.useCallback( /*#__PURE__*/function () {
  ...
  var isProductSoldOut = React.useMemo(function () {
    return !product.availableForSale;
  }, [product.availableForSale]);
  var isSelectedVariantSoldOut = React.useMemo(function () {
...
function Renderer(_ref2) {
  ...
  var _useDrop = useDrop(React.useCallback(function (state) {
    return {
  ...
  return React.createElement(React.Fragment, null, (!countdownChildren || isComplete) && React.createElement(Memo, null, children), countdownChildren && countdownState !== 'complete' && React.createElement(Memo, null, countdownChildren));
}

var Memo = /*#__PURE__*/React.memo(function (_ref3) {
...
var createStandardStorefrontClient = function createStandardStorefrontClient(_ref) {
  ...
  var graphqlClient = new graphqlRequest.GraphQLClient(endpoint, {
    headers: {
...
exports.StorefrontProvider = StorefrontProvider;
exports.calculateCountdownState = calculateCountdownState;
exports.createStandardStorefrontClient = createStandardStorefrontClient;
exports.dateOrTimestampToTimestamp = dateOrTimestampToTimestamp;
exports.formatError = formatError;
exports.formatPrice = formatPrice;
exports.getFormattedTimeDelta = getFormattedTimeDelta;
exports.getTimeDelta = getTimeDelta;
exports.isApiSupported = isApiSupported;
exports.makeAdminApiOrigin = makeAdminApiOrigin;
exports.storefrontEvents = storefrontEvents;
exports.useDrop = useDrop;
exports.useEmailSubscriptionForm = useEmailSubscriptionForm;
exports.useProductHelper = useProductHelper;
exports.useStorefront = useStorefront;
exports.useToggleState = useToggleState;
exports.zeroPad = zeroPad;
//# sourceMappingURL=react-dropify.cjs.development.js.map
